...
/*****************************************************/
RBT buscarRbl(RBT nodoRBT, int dato)
{
   RBT actual = nodoRBT;
   if(nodoRBT==NULL){
...
/*****************************************************/
void verArbolRbt(RBT arbol, int n)
{
     if(arbol==NULL)
        return;
     verArbolRbt(arbol->der, n+1);
...
void insertarRbt(RBT &arbol, int dato)
{
   RBT padre = NULL;
   RBT actual = arbol;
